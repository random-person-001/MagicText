...
class Inventory implements java.io.Serializable {
    ...
    public void testKit(){
        ...
        equip.add(item3);
        Item item5 = new Item("NeodymNeedle", "Arcane spell;\n\nA neodymium needle.\n\nIt is so magnetic, it\n will fly around walls\n to hit enemies!", "NeoNd", player, "spell", true);
        item5.dmgSpellDefine(6, 30, 7, "arcane", new SpecialText("\\", new Color(125, 100, 100)), new SpecialText("/", new Color(100, 100, 125)), true);
        spells.add(item5);
